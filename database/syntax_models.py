...
class SyntaxCategory(SQLModel, table=True):
    ...
    # Relaciones
    syntax_links: List["database.syntax_models.SentenceCategoryLink"] = Relationship(back_populates="category")
...
class SentenceCategoryLink(SQLModel, table=True):
    ...
    category: Optional["database.syntax_models.SyntaxCategory"] = Relationship(back_populates="syntax_links")
